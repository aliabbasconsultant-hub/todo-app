...
.input { padding: 12px 16px; border: 2px solid #e2e8f0; border-radius: 10px; font-size: 15px; outline: none; transition: border-color 0.2s; }
...
.todo-item { display: flex; align-items: center; gap: 12px; padding: 14px 16px; border-radius: 10px; margin-bottom: 8px; background: #f8fafc; height: 56px; overflow: hidden; }
...
.edit-input { flex: 1; padding: 7px 10px; border: 2px solid #667eea; border-radius: 8px; font-size: 15px; outline: none; min-width: 0; }
